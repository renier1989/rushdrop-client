...
const Header = () => {
  ...
  return (
    <header className="py-8 flex flex-col md:flex-row items-center justify-between">
      <a
        className="flex items-center flex-col md:flex-row cursor-pointer"
      ...
      <div className="pt-8 md:pt-0 flex flex-col md:flex-row gap-2 ">
        {usuario ? (
          <div className="flex items-center gap-3">
            <p className="font-semibold text-sky-900 text-xl">
              Hola {usuario.nombre}
            </p>
            <Link
              href="/lista-enlaces"
              className="bg-rose-700 text-white px-4 py-1 rounded-md uppercase font-bold"
            >
              Mis Enlaces
            </Link>
            <button
          ...
          <div className="flex gap-1">
            ...
            <div className=" ml-4 flex items-center gap-2">
              <a
                href="https://github.com/renier1989/rushdrop-client"
                target="_blank"
              >
                <svg
              ...
              <a
                href="https://www.linkedin.com/in/reniervargas1989/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="32"
                  fill="currentColor"
                  className="bi bi-linkedin fill-sky-900"
                  viewBox="0 0 16 16"
                >
